...
<div class="jx-btn-center"> 
	...
	?> 
                ...
                <form name="main" method="post" action="usuarioadmin_edicionp.php"  >
                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr >
    <td> <label>EDICIÓN DE USUARIO<br>  
    *Seleccione el usuario a editar<br>Editar el usuario afectará a todos los permisos de acceso al sistema
 </label>
  ...
  <tr >
    <td height="50" >   <input type="submit" value="Editar" /></td>
  </tr>
</table>
