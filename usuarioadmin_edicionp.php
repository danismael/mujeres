   		 ...
   		 <div class="jx-container-slope jx-top-slope jx-right-slope"></div>         
         	<div class="container jx-titlebar">
                <div class="sixteen columns">
                    <div class="jx-breadcrumb left"><a href="#">Home</a> > <span>Edición</span></div>
...
<div class="jx-btn-center"> 
    ...
    $d_id  = $_REQUEST["d_id"];
	  $query="select id,nombre, curp, password, correo, administrador from usuario where id ='" .$d_id. "'";
	  ...
	  if ($num_results>0)
      {
       ...
       else
	   {
		    echo '   <div class="jx-section-title-3">
               ...
               <div class="jx-blog-2"> 
<div class="jx-btn-center"> 
            <a href="usuarioadmin_edicion.php" class="jx-btn-default"><i class="fa  fa-mail-forward"></i>Regresar</a>
            </div>
			</div>
			<!-- Blog Button -->
        </div>
	...
	?> 
     ...
     <form name="main" method="post" action="usuarioadmin_edicionp1.php"  >     
                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
   <tr >
    <td> <label>EDICION USUARIO</label>
    <input name="d_nombre" type="text" id="d_nombre" size="50" maxlength="50" placeholder="Nombre" class="jx-form-text" value="<?php echo $row[1]?>">
    </td>
  </tr>
  
    <tr >
    <td>    
    <input name="d_curp" type="text" id="d_curp" size="30" maxlength="30" placeholder="Usuario" class="jx-form-text" value="<?php echo $row[2]?>">
      ...
      <tr >
    <td>
    <input name="d_password" type="text" id="d_password" size="30" maxlength="10" placeholder="Password" class="jx-form-text" value="<?php echo $row[3]?>">
    ...
    <tr >
    <td>
    <input name="d_usuario" type="text" id="d_usuario" size="30" maxlength="30" placeholder="Correo" class="jx-form-text" value="<?php echo $row[4]?>">
    </td>
  </tr> 
  
           <input type="hidden" name="d_admon" id="d_admon" value="T">
  ...
  <tr >
    <td height="50" ><input type="button" name="Submit" value="Editar" onClick="javascript:validate();"></td>
  </tr>
...
<script language=JavaScript src="valida_datos_administrador_alta.js"></script>
</body>
</html>