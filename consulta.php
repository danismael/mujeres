            ...
            <div class="container">
                ...
                <div>
                    <div class="jx-section-title-1">                
                        <div ><img src="images/logo_16.png" alt=""><BR><BR> CONSULTA DE SOLICITUD DE APOYOS CAPTURADOS</div>
...
<div class="jx-btn-center"> 
  ...
  <table class="hoverTable">
	<tr>
        ...
        <td align="left"><B>APOYO</B></td>
        <td align="left"><B>SOLICITADO</B></td>
	</tr>
      ...
      $num_results = mysql_num_rows($results);
	    ...
	    for ($i=0; $i <$num_results; $i++)
        {
           $row = mysql_fetch_array($results, MYSQLI_NUM);
		             echo "<tr>
		       <td>
               <a href = \"detalle.php?d_id=".$row[0]."\" class=sidebody02 align=center> ".$row[1]."</a></td>
               <td>
			   <a href = \"detalle.php?d_id=".$row[0]."\" class=sidebody02 align=center>".$row[2]."</a></td>
               <td>
			   <a href = \"detalle.php?d_id=".$row[0]."\" class=sidebody02 align=center>".$row[3]."</a></td>
