...
<div class="jx-btn-center"> 
	 ...
	 $d_statuslink        = strtoupper($_REQUEST["d_statuslink"]);   
	 $d_id                = strtoupper($_REQUEST["d_id"]);  
	 $d_observaciones     = strtoupper($_REQUEST["d_observaciones"]); 
	 $d_capacitaciones     = strtoupper($_REQUEST["d_capacitaciones"]); 
	 $d_factor             = strtoupper($_REQUEST["d_factor"]); 
	 ...
	 if ($d_capacitaciones == NULL) 
	  { 
	    $d_capacitaciones = '.';
	  }
	  
	  if ($d_observaciones == NULL) 
	  { 
	    $d_observaciones = '.';
	  }
 ...
 $query="update expediente set           ".
											...
											"',capacitaciones='".   $d_capacitaciones.
											"',factoresdesarrollo='".   $d_factor.
