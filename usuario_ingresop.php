...
?>  
   		 ...
   		 <div class="jx-container-slope jx-top-slope jx-right-slope"></div>         
         	<div class="container jx-titlebar">
                <div class="sixteen columns">
                    <div class="jx-breadcrumb left"><a href="#">Home</a> > <span>Solicita</span></div>
                    <div class="jx-page-title right">APOYO</div>
                </div>
            </div> 
     </div> 
    <!-- EDF Header -->
    ...
    require("conecta.php"); 
	  ...
	  $d_curp  = strtoupper($_REQUEST["d_curp"]);

	  
    
	  
	  $query1="select id, nombre from usuario where curp ='" .$d_curp. "' and password='" .$d_password. "'";
	  ...
	  if ($num_results==0)
      {
		  echo '   <div class="jx-section-title-3">
                        ...
                        <h6>Error: Esa CURP  no se encuentra registrada<br><br>
						Registre al usuario e intente de nuevo<br>
						</h6></div>
	  ...
	  else
	  {
        ...
        {
          $row = mysql_fetch_array($results1, MYSQLI_NUM);
        }
		
		$id = $row[0];
		
		 $_SESSION['var_usuario'] = $id;
		 
		echo ' <h6>Bienvenido '.$row[1].'</h6>';
		
		$query2="select * from expediente where usuariolink ='" .$id."' and statuslink=12"; //12 es capturado
		 ...
		 if ($num_results2==0)
      {
		 echo '   <div class="jx-section-title-3">
                        <div class="jx-related-date"></div>
                        <h6>No existe una solicitud de apoyo capturado.<br><br>
						<a href="expediente_alta.php" class="jx-btn-default"><i class="fa  fa-mail-forward"></i>Capturar Apoyo</a><br><br>
	  ...
	  else
	  {
		echo '   <div class="jx-section-title-3">
                        <div class="jx-related-date"></div>
                        <h6>Ya existe una solicitud de apoyo capturado.<br><br>
						<a href="expediente_edicionp.php" class="jx-btn-default"><i class="fa  fa-mail-forward"></i>Consultar Apoyo</a><br><br>
