   		 ...
   		 <div class="jx-container-slope jx-top-slope jx-right-slope"></div>         
         	<div class="container jx-titlebar">
                <div class="sixteen columns">
                    <div class="jx-breadcrumb left"><a href="#">Home</a> > <span>Baja</span></div>
	...
	if ($_SESSION['var_usuario']==0)
     {
	   echo '
		  ...
		  <div class="jx-section-title-3">
                        <div class="jx-related-date"></div>
                        <h6>Regrese a la pagina anterior e intente de nuevo.</h6></div>
...
<div class="jx-btn-center"> 
  ...
  <tr >
    <td> 
			  ...
			  $d_id  = $_REQUEST["d_id"];
	  $query1="select nombre from usuario where id ='" .$d_id. "'";
      ...
      {		  
        ...
        {
          $row = mysql_fetch_array($results1, MYSQL_NUM);
		  
		 echo '  <div class="jx-section-title-3">
                        <div class="jx-related-date"></div>
                        <h6>El usuario '.$row[0].' a sido borrado con exito.</h6></div>
	   ...
	   $query1="delete from usuario where id ='" .$d_id. "'";
	   ...
	   else
	   {
		 echo ' <div class="jx-section-title-3">
                        <div class="jx-related-date"></div>
                        <h6>El Id del usuario no existe<br>favor de consultar el correcto</h6></div>
		 ...
		 <div class="container">             
               <div class="jx-blog-2"> 
<div class="jx-btn-center"> 
            <a href="usuarioadmin_baja.php" class="jx-btn-default"><i class="fa  fa-mail-forward"></i>Regresar</a>
            </div>
			</div>
			<!-- Blog Button -->
        </div>';  
