...
?>   
	...
	?> 
                 <form name="main" method="post" action="expediente_consultap.php"  >       

                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr >
    <td> <label>CONSULTA EL ESTADO DE TU SOLICITUD</label>
    </td>
  </tr>
  ...
  <tr >
    <td height="50" ><input type="button" name="Submit" value="Consultar" onClick="javascript:validate();"></td>
  </tr>
</table>
