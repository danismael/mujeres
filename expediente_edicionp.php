...
?>  
    ...
    <div role="main" class="main no-top-padding">
     ...
     if (isset($_SESSION['var_curp'])== False)
    {
...
<div class="jx-btn-center"> 
	 ...
	 //Con el curp saco el usuariolink
	 
	 $d_curp = $_SESSION['var_curp'];
	 
	 $query="select id from usuario where curp ='" .$d_curp. "'";
	 ...
	 //Obtengo los datos
	  ...
	  localidad, hijos,  fechanacimiento, celular, apoyolink, id from expediente where  statuslink=12  and usuariolink =" .$d_userlink. "";
	  ...
	  if ($num_results>0)
      {
       ...
       else
	   {
		    echo '   <div class="jx-section-title-3">
                        <div class="jx-related-date"></div>
                        <h6>Error: El Id del expediente no existe<br>
...
<div class="jx-btn-center"> 
	...
	?> 
        ...
        <form name="form" method="post" action="expediente_edicionp1.php">    
                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
   <tr >
    <td> <label>EDICION SOLICITUD</label>
...
<input name="d_hijos" type="text" id="d_hijos" size="30" maxlength="5" placeholder="Número de Hijos menores de 18 años" class="jx-form-text" value="<?php echo $hijos?>">
 ...
 <input name="d_fechanacimiento" type="text" id="d_fechanacimiento" size="30" maxlength="30" placeholder="Fecha de Nacimiento YYYY/MM/DD" class="jx-form-text" value="<?php echo $fechanacimiento?>">
  ...
  <tr >
    <td height="50" ><input type="submit" name="button" id="button" value="Enviar"></td>
  </tr>
