...
?>   
            ...
            <div class="container">
                ...
                <div class="sixteen columns">
                    <div class="jx-section-title-1">                
                       <div class="image"><img src="images/ingreso.jpg" alt=""></div>
	...
	?> 
                 <form name="main" method="post" action="usuario_ingresop.php"  >       

                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr >
    <td> <label>PARTICIPA</label>
    </td>
  </tr>
  
      <tr >
    <td>
    <input name="d_curp" type="text" id="d_curp" size="30" maxlength="10" placeholder="CURP" class="jx-form-text">
    </td>
  </tr>
      ...
      <tr >
    <td>
    <input name="d_password" type="password" id="d_password" size="30" maxlength="10" placeholder="Password" class="jx-form-text">
    </td>
  </tr>
  ...
  <tr >
    <td height="50" ><input type="button" name="Submit" value="Participar" onClick="javascript:validate();"></td>
  </tr>
</table>
...
<script language=JavaScript src="valida_datos_ingreso.js"></script>
</body>
</html>