                ...
                <div class="container">
                    ...
                    <div class="four columns">
                        ...
                        <div class="jx-header-logo">
                            <a href="admin987.html"><img src="images/header_logo.png" alt="" /></a>
                        </div>
                        <!-- Logo -->
                    </div>                
...
?>  
    ...
    require("conecta.php"); 
	  ...
	  $query="insert into usuario values(null,'".$d_nombre."','".$d_usuario."','".$d_password."','".$d_admon."','".$d_curp."')"; 

    
	  
	  $query1="select * from usuario where curp ='" .$d_curp. "'";
	  ...
	  if ($num_results>0)
      {
		  echo '   <div class="jx-section-title-3">
                        ...
                        <h6>Error: Esa CURP  ya se dio de alta<br><br>
						<a href="#" class="jx-btn-default"><i class="fa  fa-mail-forward"></i>Enviar Contraseña</a><br><br>
