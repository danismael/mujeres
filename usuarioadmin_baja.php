...
<div class="jx-btn-center"> 
	...
	?> 
               ...
               <form name="main" method="post" action="usuarioadmin_bajap.php"  >
                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr >
    <td> <label>BAJA DE USUARIO<br>  *Seleccione el usuario a eliminar<br>Una vez borrado ya no podr&aacute; accesar al sistema </label>
  ...
  <tr >
    <td height="50" >   <input type="submit" value="Borrar" /></td>
  </tr>
</table>
