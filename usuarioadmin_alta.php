...
?>   
   		 ...
   		 <div class="jx-container-slope jx-top-slope jx-right-slope"></div>         
         	<div class="container jx-titlebar">
                <div class="sixteen columns">
                    <div class="jx-breadcrumb left"><a href="#">Home</a> > <span>Registro</span></div>
            ...
            <div class="container">
                ...
                <div class="sixteen columns">
                    <div class="jx-section-title-1">                
                       <div class="image"><img src="images/usuario.jpg" alt=""></div>
	...
	?> 
                 <form name="main" method="post" action="usuarioadmin_altap.php"  >       

                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr >
    <td> <label>ALTA ADMINISTRADOR</label>
    <input name="d_nombre" type="text" id="d_nombre" size="50" maxlength="50" placeholder="Nombre Completo" class="jx-form-text">
    </td>
  </tr>
  
      <tr >
    <td>
    <input name="d_curp" type="text" id="d_curp" size="30" maxlength="30" placeholder="Usuario" class="jx-form-text">
    </td>
  </tr>
      ...
      <tr >
    <td>
    <input name="d_password" type="text" id="d_password" size="30" maxlength="10" placeholder="Password" class="jx-form-text">
    </td>
  </tr>
  
      <tr >
    <td>
    <input name="d_usuario" type="text" id="d_usuario" size="30" maxlength="30" placeholder="Correo" class="jx-form-text">
    </td>
  </tr>   
  ...
  <tr >
    <td height="50" ><input type="button" name="Submit" value="Registrar" onClick="javascript:validate();"></td>
  </tr>
</table>
