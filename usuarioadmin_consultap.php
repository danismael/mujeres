	...
	if ($_SESSION['var_usuario']==0)
     {
	   echo '
		 ...
		 <div class="container">             
               <div class="jx-blog-2"> 
<div class="jx-btn-center"> 
            <a href="admin987.html" class="jx-btn-default"><i class="fa  fa-mail-forward"></i>Regresar</a>
            </div>
			</div>
			<!-- Blog Button -->
        </div>';
     ...
     $d_id  = $_REQUEST["d_id"];  
	$query="select usuario.id, usuario.nombre, usuario.curp, usuario.password,  usuario.correo, usuario.administrador
	         from usuario
        where  usuario.id ='" .$d_id. "'";
...
<div class="jx-btn-center"> 
   ...
   <tr >
    <td align="left">  CONSULTA DE USUARIO ADMINISTRADOR
    <label><b>NOMBRE: </b> <?php echo $row[1]?></label>
    </td>
  </tr>
  
    <tr >
    <td>
    <label><b>USUARIO: </b> <?php echo $row[2]?></label>
      ...
      <tr >
    <td>
    <label><b>PASSWORD: </b><?php echo $row[3]?></label>
    </td>
  </tr>
  
        <tr >
    <td>
   <label><b>CORREO: </b><?php echo $row[4]?></label>
    </td>
  </tr>
    ...
    <tr >
    <td>
   <label><b>ES ADMON: </b><?php echo $row[5]?></label>
      </td>
  </tr>
