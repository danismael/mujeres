...
<div class="jx-btn-center"> 
	...
	?> 
               ...
               <form name="main" method="post" action="usuarioadmin_consultap.php"  >
                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr >
    <td> <label>CONSULTA DE USUARIO ADMINISTRADOR<br>  *Seleccione el usuario a consultar </label>
  ...
  <tr >
    <td height="50" >   <input type="submit" value="Consultar" /></td>
  </tr>
</table>
